    ...
    @objc func addButtonTapped() {
        ...
        NetworkManager.shared.getUserInfo(for: username) { [weak self] result in
            ...
            case .success(let user):
                ...
                PersistanceManager.updateWith(favorite: favorites, actionType: .add) { [weak self] error in
                    guard let self = self else { return }
            ...
            case .success(let followers):
                ...
                if self.followers.isEmpty {
                    ...
                    DispatchQueue.main.async {
                        self.showMessageLabel(message: message, in: self.view)
                    }
                }
...
extension FollowerListVC: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let selectedIndex = activeArray[indexPath.item]
        
        let userInfoVC = UserInfoVC()
        userInfoVC.username = selectedIndex.login
